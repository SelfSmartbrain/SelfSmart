...
class FitnessConfig:
    ...
    metric_weights: Dict[FitnessMetric, float] = field(default_factory=lambda: {
    ...
    qdrant_collections: List[str] = field(default_factory=lambda: [
        "knowledge",
        "memories", 
        "reflections",
        "strategies",
    ...
    neo4j_labels: List[str] = field(default_factory=lambda: [
        "Belief",
        "Fact", 
        "Concept",
        "Rule",
