...
async def execute_candidate_in_sandbox(
    request: SandboxExecutionRequest, script_path: str = "candidate_architecture/main.py"
    ...
    """
    logger.info(
        f"Starting sandbox execution for candidate {request.candidate_id}, run_id {request.run_id}"
    )
