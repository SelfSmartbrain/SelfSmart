...
class RepoOptimizer:
    ...
    async def generate_optimization_plan(
        ...
        filtered = [
            op
            for op in self._opportunities
            if op.priority <= max_priority and effort_order.get(op.effort, 2) <= max_effort_value
        ]
    ...
    def get_opportunities(
        ...
        if optimization_type:
            opportunities = [
                op for op in opportunities if op.optimization_type == optimization_type
            ]
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "by_type": {
                opt_type.value: len(
                    [o for o in self._opportunities if o.optimization_type == opt_type]
                )
