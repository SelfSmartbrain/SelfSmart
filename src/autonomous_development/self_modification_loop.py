...
class SelfModificationLoop:
    ...
    async def run_cycle(self, components: Optional[List[str]] = None) -> ModificationCycle:
        ...
        try:
            ...
            safe_patches = [
                p for p, a in zip(cycle.generated_patches, cycle.safety_assessments) if a.is_safe
            ]
            ...
            if self.config.require_sandbox_pass:
                ...
                passed_patches = [p for p, r in zip(safe_patches, cycle.test_results) if r.passed]
