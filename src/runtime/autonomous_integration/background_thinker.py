...
class ThinkingConfig:
    ...
    mode_weights: Dict[ThinkingMode, float] = field(default_factory=lambda: {
    ...
    # Curiosity
    curiosity_topics: List[str] = field(default_factory=lambda: [
        "causality", "patterns", "anomalies", "optimization", "emergence"
    ])
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_thought": (
                ...
                if self._thought_history else None
            ),
        }
