...
class MemoryConsolidator:
    ...
    async def consolidate(self) -> ConsolidationResult:
        ...
        try:
            ...
            self._total_promoted += (result.promoted_to_episodic + 
            ...
            while True:
                ...
                for key in keys:
                    ...
                    try:
                        ...
                        age_hours = (datetime.utcnow().timestamp() - data.get("timestamp", 0)) / 3600
                        
                        # Check promotion criteria
                        if (importance >= self.config.importance_threshold or
                            access_count >= self.config.access_count_threshold) and \
                    ...
                    if confidence >= self.config.confidence_threshold:
                        ...
                        if self.kernel:
                            try:
                                ...
                                if decision.get("confidence", 0) > self.config.min_connection_strength:
                                    # Store in Neo4j
