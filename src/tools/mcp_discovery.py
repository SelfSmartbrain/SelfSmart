...
async def discover_mcp_resources(
    client: MCPClient, server_name: Optional[str] = None
) -> List[Dict[str, Any]]:
    """
...
async def get_full_server_capabilities(
    client: MCPClient, server_name: str
...
class MCPCatalogManager:
    ...
    async def connect_server(
        self, server_key: str, env_overrides: Optional[Dict[str, str]] = None
    ) -> bool:
    ...
    async def connect_all(
        self, env_overrides: Optional[Dict[str, Dict[str, str]]] = None
    ) -> Dict[str, bool]:
