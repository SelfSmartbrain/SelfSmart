        ...
        if not usage_data:
            ...
            if operation_counts:
                ...
                if operation_counts[most_common_op] > 3:
                    recommendations.append(f"Cache results for '{most_common_op}' operations (used {operation_counts[most_common_op]} times)")
            ...
            if avg_tokens_per_task > 1000:
                ...
                recommendations.append("Token usage is efficient - consider increasing context window for better results")
            ...
            if len(recommendations) >= 3:
                base_savings = int(base_savings * 1.5)  # Bonus for multiple optimization opportunities
