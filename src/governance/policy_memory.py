...
class PolicyMemory:
    ...
    def get_effectiveness_records(self, policy_id: str) -> List[PolicyEffectivenessRecord]:
        ...
        return [
            self.effectiveness_records[rid]
            for rid in record_ids
            if rid in self.effectiveness_records
        ]
    ...
    def get_policy_statistics(self, policy_id: str) -> Dict[str, Any]:
        ...
        if effectiveness_records:
            avg_effectiveness = sum(r.effectiveness_score for r in effectiveness_records) / len(
                effectiveness_records
            )
            avg_compliance = sum(r.compliance_rate for r in effectiveness_records) / len(
                effectiveness_records
            )
        else:
