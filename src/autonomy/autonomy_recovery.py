...
class AutonomyRecovery:
        ...
        try:
            if recovery_action.strategy == RecoveryStrategy.RETRY_WITH_BACKOFF:
                ...
                recovery_result["message"] = (
                    f"Recovery action requires: {recovery_action.strategy.value}"
                )
    ...
    async def handle_failure(
        ...
        return {
            ...
            "should_retry": recovery_action.strategy
            in [
                RecoveryStrategy.RETRY_IMMEDIATE,
                RecoveryStrategy.RETRY_WITH_BACKOFF,
            ],
    ...
    def get_failure_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recovery_success_rate": (
                successful_recoveries / len(self.recovery_history) if self.recovery_history else 0.0
            ),
        }
