...
class PatchGenerator:
    ...
    async def generate_patch(
        self, plan: ExecutionPlan, context: Optional[Dict] = None
    ) -> GeneratedPatch:
...
Respond with ONLY the Python test code, no explanation or markdown."""
        ...
        response = await self.llm.ainvoke(
            [
                SystemMessage(
                    content="You are an expert test engineer. Respond with ONLY executable Python test code."
                ),
...
Respond with ONLY the code, no explanation or markdown."""
        ...
        response = await self.llm.ainvoke(
            [
                SystemMessage(
                    content="You are an expert software engineer. Respond with ONLY executable code."
                ),
                HumanMessage(content=prompt),
            ]
        )
    ...
    async def generate_bug_fix_patch(
        self, error_message: str, file_path: str, context: Dict
    ) -> GeneratedPatch:
    ...
    async def generate_feature_patch(
        self, feature_description: str, file_path: str, context: Dict
    ) -> GeneratedPatch:
    ...
    async def generate_refactor_patch(
        self, refactor_description: str, file_path: str, context: Dict
    ) -> GeneratedPatch:
...
Respond with ONLY the fixed code, no explanation or markdown."""
        ...
        response = await self.llm.ainvoke(
            [
                SystemMessage(
                    content="You are an expert debugger. Respond with ONLY the fixed code."
                ),
                HumanMessage(content=prompt),
            ]
        )
...
Respond with ONLY the implementation code, no explanation or markdown."""
        ...
        response = await self.llm.ainvoke(
            [
                SystemMessage(
                    content="You are an expert software architect. Respond with ONLY implementation code."
                ),
                HumanMessage(content=prompt),
            ]
        )
...
Respond with ONLY the refactored code, no explanation or markdown."""
        ...
        response = await self.llm.ainvoke(
            [
                SystemMessage(
                    content="You are an expert code refactoring specialist. Respond with ONLY refactored code."
                ),
                HumanMessage(content=prompt),
            ]
        )
