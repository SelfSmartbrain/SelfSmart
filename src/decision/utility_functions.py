...
class UtilityFunctions:
    ...
    def risk_premium(
        ...
        expected_value = sum(
            outcome * probability for outcome, probability in zip(outcomes, probabilities)
        )

        certainty_equivalent = self.certainty_equivalent(function_name, outcomes, probabilities)
