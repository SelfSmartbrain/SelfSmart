...
class TradeoffEngine:
    ...
    def find_balanced_solution(
        ...
        for tradeoff in tradeoffs:
            factor_values[tradeoff.factor1] = (
                factor_values.get(tradeoff.factor1, 0.0) + tradeoff.factor1_value
            )
            factor_counts[tradeoff.factor1] = factor_counts.get(tradeoff.factor1, 0) + 1

            factor_values[tradeoff.factor2] = (
                factor_values.get(tradeoff.factor2, 0.0) + tradeoff.factor2_value
            )
