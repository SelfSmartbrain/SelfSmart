...
class ConceptRelationships:
    ...
    def add_relationship(
        ...
        success = self.graph.add_relationship(from_id, to_id, rel_type.value, weight)
    ...
    def infer_relationship(
        ...
        if self.find_transitive_relationship(from_id, to_id, RelationshipType.IS_A, max_depth=2):
